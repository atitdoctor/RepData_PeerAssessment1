...
newMedian - oldMedian
```
So, after cleaning (assuming for) the missing data, the new mean of total steps taken per day is the same as that of the old mean; while the new median of total steps taken per day is greater than that of the old median (by a negligible factor)
...
Showing the difference between weekday and weekend activity through the histogram
```{r}
